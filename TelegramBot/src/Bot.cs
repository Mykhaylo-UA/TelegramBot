...
namespace TelegramBot
{
    public class Bot : IHostedService
    {
        ...
        private const string UnknownCommandMessage = "Unknown command. Try /help for a list of available commands.";
        ...
        private async Task ProcessChatMessage(object sender, ChatMessageEventArgs chatMessageArgs)
        {
            ...
            {
                var command = _serviceProvider.GetServices<IBotCommand>().SingleOrDefault(x =>
